  ...
  return (
    ...
    >
      <Link
        ...
        className="group block p-6 rounded-2xl bg-white border border-stone-200 hover:border-dorado/30 hover:shadow-lg hover:shadow-dorado/5 transition-500 h-full"
      >
        {nota.images[0] && (
        ...
        <h3 className="text-lg font-bold text-ink mb-2 group-hover:text-dorado transition-300 line-clamp-2">
          {nota.title}
        </h3>
        {nota.author && (
          <p className="text-ink-muted text-sm mb-3">{nota.author}</p>
        )}
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-ink mb-8">
            ...
            >
              ...
              <p className="text-ink-light text-base sm:text-lg font-light leading-relaxed italic">
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-ink-muted text-lg font-light leading-relaxed mb-10">
            ...
            <Link href="/nuevo-templo">
              <motion.span
                ...
                whileTap={{ scale: 0.97 }}
                className="relative group inline-flex items-center gap-3 px-10 py-5 rounded-2xl bg-linear-to-r from-dorado to-dorado-dark text-white cursor-pointer overflow-hidden"
              >
