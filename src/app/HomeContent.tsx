...
export default function HomeContent() {
  return (
    <section className="relative min-h-svh flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-b from-stone-50 via-white to-stone-50" />

      <FloatingCrosses count={6} />

      {/* Ambient glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 rounded-full bg-dorado/6 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          <Image
            ...
            width={400}
            height={120}
            className="mx-auto h-28 sm:h-36 w-auto no-interact mb-8 logo-dark opacity-80"
            priority
          />
        </motion.div>
        ...
        >
          ...
          <p className="text-ink-muted text-lg sm:text-xl font-light leading-relaxed max-w-2xl mx-auto">
        ...
        >
          <Link
            ...
            className="group relative px-8 py-4 rounded-xl border border-dorado/30 bg-white hover:bg-dorado/5 hover:border-dorado/50 transition-500 overflow-hidden shadow-sm"
          >
            ...
            <div className="relative flex items-center gap-3">
              <span className="text-ink text-sm font-medium uppercase tracking-wider">
                Padre Jorge Gandur
              </span>
              <ArrowRightIcon
          ...
          <Link
            href="/nuevo-templo"
            className="group relative px-8 py-4 rounded-xl bg-linear-to-r from-dorado to-dorado-dark text-white hover:shadow-lg hover:shadow-dorado/20 transition-500 overflow-hidden"
          >
