  ...
  return (
    <div className="bg-stone-950">
      ...
      >
        {heroImage && (
          <motion.div className="absolute inset-0" style={{ y: heroY }}>
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-linear-to-b from-stone-950/50 via-stone-950/30 to-stone-950" />
          </motion.div>
        )}

        {!heroImage && (
          <div className="absolute inset-0 bg-linear-to-b from-stone-900 to-stone-950" />
        )}
        ...
        >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl lg:text-6xl font-black leading-tight text-white"
          >
            {nota.title}
          </motion.h1>
          ...
          {nota.subtitle && (
            <motion.p
              ...
              className="mt-2 text-text-secondary text-sm sm:text-base font-light"
            >
              {nota.subtitle}
            </motion.p>
          )}
      ...
      <section className="relative py-16 px-4">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 rounded-full bg-dorado/2 blur-[100px] pointer-events-none" />
        ...
        <article className="relative max-w-3xl mx-auto">
          <motion.div
            ...
            className="bg-surface rounded-2xl p-8 sm:p-12 border border-dorado/10"
          >
            ...
            {nota.author && (
              <motion.footer
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="mt-10 pt-8 border-t border-dorado/10"
              >
              ...
              {galleryImages.map((img, i) => (
                ...
                >
                  <div className="relative aspect-4/3 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-stone-950/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-500" />
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section className="relative py-16 px-4">
          <div className="max-w-3xl mx-auto">
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden border border-dorado/10"
            >
      ...
      {/* ═══════════════════ BOTTOM NAV ═══════════════════ */}
      <section className="py-16 px-4 border-t border-dorado/5">
