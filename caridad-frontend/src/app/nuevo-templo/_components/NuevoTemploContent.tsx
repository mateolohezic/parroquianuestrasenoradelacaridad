...
export default function NuevoTemploContent() {
  ...
  return (
    <div className="bg-stone-950">
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-text-light text-lg sm:text-xl font-light leading-relaxed max-w-2xl mx-auto"
          >
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative space-y-6 text-text-light text-base sm:text-lg font-light leading-relaxed">
              <p>
              ...
              <p>
                ...
                <span className="text-white font-semibold">más de mil personas</span>{" "}
      ...
      {/* ═══════════════════ STATS ═══════════════════ */}
      <section className="py-20 px-4 border-y border-dorado/5">
      ...
      {/* ═══════════════════ GALLERY ═══════════════════ */}
      <section className="relative py-32 px-4 bg-stone-900/30">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            eyebrow="Galería"
                ...
                >
                  <motion.div
                    ...
                    className={`p-6 rounded-2xl border transition-500 ${
                      etapa.active
                        ? "bg-dorado/10 border-dorado/30 animate-glow-pulse"
                        : "bg-surface border-dorado/10 hover:border-dorado/20"
                    }`}
                  >
                      ...
                      <div className="mt-4 pt-4 border-t border-dorado/10">
                        ...
                        <ul className="space-y-1.5">
                          {etapa.subEtapas.map((sub) => (
                            <li
                              key={sub}
                              className="text-text-tertiary text-xs leading-relaxed"
                            >
                              {sub}
                            </li>
                          ))}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="relative group px-10 py-5 rounded-2xl bg-linear-to-r from-dorado to-dorado-dark text-stone-950 cursor-pointer overflow-hidden"
            >
...
function ParallaxImage({
  ...
  return (
    <motion.div
      ...
      className="relative group rounded-2xl overflow-hidden border border-dorado/10 hover:border-dorado/30 transition-500"
    >
      ...
      <div className="absolute inset-0 bg-linear-to-t from-stone-950/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-500" />
    </motion.div>
  );
}
...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -4 }}
      className="p-6 rounded-2xl bg-surface border border-dorado/10 hover:border-dorado/20 transition-500"
    >
...
function GalleryCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group relative rounded-2xl overflow-hidden border border-dorado/10 hover:border-dorado/30 transition-500"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5">
        <p className="text-white text-sm font-semibold group-hover:text-dorado transition-300">
          {title}
        </p>
      </div>
    </motion.div>
