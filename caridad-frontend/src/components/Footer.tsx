...
export default function Footer() {
  return (
    <footer className="relative bg-stone-950 border-t border-dorado/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            <Image
              ...
              width={200}
              height={60}
              className="h-16 w-auto no-interact opacity-80"
            />
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-dorado text-sm font-semibold uppercase tracking-[3px]">
              Navegación
            </h3>
            <nav className="space-y-2" aria-label="Footer">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-text-secondary hover:text-dorado transition-300 text-sm"
                >
                  {link.label}
                </Link>
              ))}
          ...
          >
            ...
            <div className="space-y-3">
              <address className="flex items-start gap-3 text-text-secondary text-sm not-italic">
