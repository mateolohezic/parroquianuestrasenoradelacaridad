  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-40 transition-500 ${
        scrolled
          ? "bg-stone-950/95 backdrop-blur-md shadow-lg shadow-dorado/5"
          : "bg-transparent"
      }`}
        ...
        <div className="flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <Image
              ...
              width={160}
              height={50}
              className="h-12 w-auto no-interact opacity-90 group-hover:opacity-100 transition-300"
              priority
            />
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-300 tracking-wide uppercase ${
                    isActive
                      ? "text-dorado"
                      : "text-white/70 hover:text-dorado"
                  }`}
          ...
          <button
            ...
            className="md:hidden text-white/80 hover:text-dorado transition-300 p-2"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-stone-950/98 backdrop-blur-lg border-t border-dorado/10 overflow-hidden"
          >
                    ...
                    <Link
                      ...
                      className={`block px-4 py-3 rounded-lg transition-300 text-sm uppercase tracking-wider ${
                        isActive
                          ...
                          : "text-white/70 hover:text-dorado hover:bg-dorado/5"
                      }`}
                      aria-current={isActive ? "page" : undefined}
                    >
                      {link.label}
